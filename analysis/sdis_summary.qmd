...
ndis <- read_csv(here("data", "v1.0", "NDIS_time_series.csv"), show_col_types = FALSE)
sdis <- read_csv(here("data", "v1.0", "SDIS_cross_section.csv"), show_col_types = FALSE)
...
```{r}
#| label: top-discrepancies
#| echo: true
#| code-fold: true
#| results: hold
#| code-summary: "Show discrepancy analysis code"
