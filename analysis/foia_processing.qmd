...
4.  **Save outputs**
    ...
    -   `data/foia/intermediate/foia_state_metadata.csv` — one row per state
        ...
        `foia_data_clean.csv` to `data/foia/final/foia_data_clean.csv`. Versioned releases are managed via `analysis/version_freeze.qmd`.
...
#| message: false
#| code-fold: true
#| code-summary: "Show helper functions setup"
...
#| echo: true
#| code-fold: true
#| code-summary: "Show per-state files loading code"
...
#| code-fold: true
#| results: hold
#| code-summary: "Show the master foia_combined dataframe elaboration code"
...
#| message: false
#| code-fold: true
#| code-summary: "Show the foia_state_metadata table elaboration code"
...
#| echo: true
#| code-fold: true
#| code-summary: "Show unknown addition code"
#| results: hold
...
#| echo: true
#| code-fold: true
#| code-summary: "Show combined addition code"
#| results: hold
...
#| echo: true
#| code-fold: true
#| code-summary: "Show percentage calculation code"
#| results: hold
...
#| echo: true
#| code-fold: true
#| code-summary: "Show terminology standardization code"
#| results: hold
...
#| echo: true
#| code-fold: true
#| code-summary: "Show California data preparation to combined dataset"
#| results: hold
...
#| echo: true
#| code-fold: true
#| code-summary: "Show California data preparation and addition to metadata table"
#| results: hold
...
#| echo: true
#| code-fold: true
#| code-summary: "Show the summary statistics code"
#| results: hold
...
#| echo: true
#| code-fold: true
#| code-summary: "Show Florida data preparation to combined dataset"
#| results: hold
...
#| echo: true
#| code-fold: true
#| code-summary: "Show Florida data preparation and addition to metadata table"
#| results: hold
...
#| echo: true
#| code-fold: true
#| code-summary: "Show value conversion code"
#| results: hold
...
#| echo: true
#| code-fold: true
#| code-summary: "Show percentage recalculation code"
#| results: hold
...
#| echo: true
#| code-fold: true
#| code-summary: "Show combined total calculation code"
#| results: hold
...
#| echo: true
#| code-fold: true
#| code-summary: "Show count calculation code"
#| results: hold
...
#| echo: true
#| code-fold: true
#| code-summary: "Show Indiana data preparation to combined dataset"
#| results: hold
...
#| echo: true
#| code-fold: true
#| code-summary: "Show Indiana data preparation and addition to metadata table"
#| results: hold
...
#| echo: true
#| code-fold: true
#| code-summary: "Show count recalculation code"
#| results: hold
...
#| echo: true
#| code-fold: true
#| code-summary: "Show Maine data preparation to combined dataset"
#| results: hold
...
#| echo: true
#| code-fold: true
#| code-summary: "Show Maine data preparation and addition to metadata table"
#| results: hold
...
#| echo: true
#| code-fold: true
#| code-summary: "Show Nevada data preparation to combined dataset"
#| results: hold
...
#| echo: true
#| code-fold: true
#| code-summary: "Show Nevada data preparation and addition to metadata table"
#| results: hold
...
#| echo: true
#| code-fold: true
#| code-summary: "Show difference handle code"
...
#| echo: true
#| code-fold: true
#| code-summary: "Show South Dakota data preparation to combined dataset"
#| results: hold
...
#| echo: true
#| code-fold: true
#| code-summary: "Show South Dakota data preparation and addition to metadata table"
#| results: hold
...
#| echo: true
#| code-fold: true
#| code-summary: "Show male addition code"
#| results: hold
...
#| echo: true
#| code-fold: true
#| code-summary: "Show Texas data preparation to combined dataset"
#| results: hold
...
#| echo: true
#| code-fold: true
#| code-summary: "Show Texas data preparation and addition to metadata table"
#| results: hold
...
datatable(
  ...
  options = list(
    ...
    pageLength = 10,
    columnDefs = list(
      list(className = 'dt-left', targets = 0:(ncol(foia_combined)-1))
    ),
    autoWidth = TRUE,
    language = list(
      search = "Filter:",
...
datatable(
  ...
  options = list(
    ...
    pageLength = 8,
    columnDefs = list(
      list(className = 'dt-left', targets = 0:(ncol(foia_state_metadata)-1))
    ),
    autoWidth = TRUE,
    language = list(
      search = "Filter:",
  ...
  formatStyle(
    columns = names(foia_state_metadata),
    fontSize = '12px',
    lineHeight = '90%'
  )
```
...
#| message: false
#| code-fold: true
#| code-summary: "Show final saving process code"
#| results: hold
