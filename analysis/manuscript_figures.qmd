...
ggsave(
  filename = file.path(figures_dir, "fig3_maps.pdf"),
...
ggsave(
  filename = file.path(figures_dir, "fig5_anomaly_log.pdf"),
...
ggsave(
  filename = file.path(figures_dir, "fig6_heatmap_raw_clean.pdf"),
...
p_investigations_grid <- ggplot() +
  ...
  labs(x = "Year", y = NULL, title = "(E) Investigations Aided")
...
ggsave(file.path(figures_dir, "fig7_verification_grid.pdf"),
  plot = plots_grid,
  width = 20,
  height = 20,
  dpi = 300,
